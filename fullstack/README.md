# offTuc full-stack
Creado con la base de:
https://github.com/crsandeep/simple-react-full-stack

## Quick Start: Cómo instalar el fullstack

### Pre requisitos
Tener instalado npm y docker

Crear el container para mongo y correrlo
```bash
docker run -d -p 27017:27017 --name mongo-offtuc mongo:3.4-jessie
```

Crear un archivo .env en /src/server/ dentro del proyecto una vez clonado. 
Se pueden utilizar los siguientes datos iniciales distintos a los de producción:
